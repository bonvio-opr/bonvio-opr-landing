...
<head>
    ...
    <title>НПО БОНВИО</title>

    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="img/galk-white.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="bower_components/SlitSlider/css/style.css">
    ...
    <script src="bower_components/SlitSlider/js/jquery.slitslider.js"></script>
    <script src="bower_components/SlitSlider/js/jquery.ba-cond.min.js"></script>
    <script src="bower_components/mixitup/jquery.mixitup.min.js"></script>
...
<header id="navigation" class="navbar-inverse navbar-fixed-top animated-header">
    <div class="container">
        <div class="navbar-header">
            ...
            <!-- logo -->
            <h1 class="navbar-brand clearfix visible-md visible-lg">
                <a href="#body">
                    <span
                        style="background: #4bac3a; padding: 5px 10px 10px 12px; position: relative; top: -5px; color: #fff">
                        <img src="img/galk-white.png" style="width: 20px"></span><span
                        style="padding: 5px 8px; color: #4bac3a; position: relative; top: -2px;" >НПО БОНВИО</span>
                </a>
            </h1>
            <h1 class="navbar-brand clearfix visible-sm visible-xs">
                <a href="#body">
                    <span
                        style="background: #4bac3a; padding: 5px 10px 10px 12px; position: relative; top: -5px; color: #fff">
                        <img src="img/galk-white.png" style="width: 20px"></span>
                </a>
            </h1>
            <!-- /logo -->
        </div>
...
<main class="site-content" role="main">
    ...
    <!--	<section id="home-slider">
            ...
            </div>&lt;!&ndash; /slider-wrapper &ndash;&gt;
        </section>-->
            ...
            <div class="footer-content">
                ...
                <form action="#" method="post" class="subscribe-form wow animated fadeInUp">
                    <div class="input-field">
                        <input type="email" class="subscribe form-control" placeholder="Ваш email...">
